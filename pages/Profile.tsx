...
const Profile: React.FC<ProfileProps> = ({ user, setUser }) => {
  ...
  return (
    <div className="p-6 animate-reveal">
      ...
      <div className="bg-s2 border border-white/5 rounded-[32px] p-6 flex items-center gap-6 mb-8 shadow-xl">
        <div className="w-20 h-20 bg-brand-orange/10 border-2 border-brand-orange rounded-full flex items-center justify-center text-4xl shrink-0 shadow-[0_0_20px_rgba(255,92,0,0.15)]">
      ...
      <div className="bg-s2 border border-white/5 rounded-[32px] overflow-hidden shadow-2xl mb-8">
        <button 
        ...
        <div className={`grid transition-[grid-template-rows,opacity] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${showHistory ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
      ...
      <div className="mt-12 text-center pb-8">
         ...
         <div className="text-[8px] text-t3 opacity-20">Version 2.4.0</div>
      </div>
    </div>
  );
};
